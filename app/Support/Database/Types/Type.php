...
use App\Support\Database\Platform\AbstractPlatform;
...
abstract class Type extends DoctrineType
{
    ...
    public static function getPlatformTypes()
    {
        ...
        $platform = AbstractSchemaManager::getDatabasePlatform();

        static::$platformTypes = AbstractPlatform::getPlatformTypes(
            $platform->getName(),
            static::getPlatformTypeMapping($platform)
        );

        (static::$platformTypes)->map(function ($type) {
    ...
    protected static function getPlatformCustomTypes($name)
    {
        $ds = DIRECTORY_SEPARATOR;
        $path = __DIR__ . $ds . $name . $ds;
    ...
    protected static function addCustomTypeOptions($name)
    {
        static::registerCommonCustomTypeOptions();

        AbstractPlatform::registerPlatformCustomTypeOptions($name);
